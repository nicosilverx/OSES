# 1 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c"
# 1 "C:\\TMP_WO~1\\lab2_v2\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c"
# 54 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c"
...
# 55 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c" 2
...
# 133 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c"
  if (p_curr_tcb->current_prio < p_tcb_act->current_prio) {
    OsEE_SN * const
      p_new_stk = osEE_sn_alloc(&p_ccb->p_free_sn);
# 149 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c"
...
)
{
  ...
  (void)p_kdb;
  osEE_lock_core(p_cdb);
# 213 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c"
  {
...
# 250 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c"
OsEE_bool
  osEE_scheduler_task_unblocked
(
  OsEE_KDB * p_kdb,
...
)
{
  ...
  osEE_unlock_core(p_cdb);
# 301 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c"
  return is_preemption;
}
...
# 371 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c"
...

      {
        ...
        if (p_prev == 
# 377 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c" 3 4
                     ((void *)0)
# 377 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c"
                         ) {
...
)
{
  ...
  if (p_prev != 
# 416 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c" 3 4
               ((void *)0)
# 416 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c"
                   ) {
    OsEE_TDB * const p_curr = p_ccb->p_curr;
...
)
{
  ...
  (void)p_kdb;
  if (p_sn == 
# 451 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c" 3 4
             ((void *)0)
# 451 "C:\\TMP_WO~1\\lab2_v2\\erika\\src\\ee_oo_sched_partitioned.c"
                 ) {
    osEE_lock_core(p_cdb);
