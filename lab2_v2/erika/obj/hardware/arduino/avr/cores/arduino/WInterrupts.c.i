...
# 80 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
    switch (interruptNum) {
# 172 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
    case 0:

      
# 174 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
     (*(volatile uint8_t *)(0x69)) 
# 174 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
           = (
# 174 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
              (*(volatile uint8_t *)(0x69)) 
# 174 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
...
# 175 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
     (*(volatile uint8_t *)((0x1D) + 0x20)) 
# 175 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
           |= (1 << 
# 175 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
                    0
# 175 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
                        );
# 185 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
      break;

    case 1:

      
# 189 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
     (*(volatile uint8_t *)(0x69)) 
# 189 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
           = (
# 189 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
              (*(volatile uint8_t *)(0x69)) 
# 189 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
...
# 190 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
     (*(volatile uint8_t *)((0x1D) + 0x20)) 
# 190 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
           |= (1 << 
# 190 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
                    1
# 190 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
                        );
# 200 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
      break;

    case 2:
# 213 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
      break;
...
void detachInterrupt(uint8_t interruptNum) {
  if(interruptNum < 2) {
    ...
    switch (interruptNum) {
# 292 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
    case 0:

      
# 294 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
     (*(volatile uint8_t *)((0x1D) + 0x20)) 
# 294 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
           &= ~(1 << 
# 294 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
                     0
# 294 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
...
# 306 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
     (*(volatile uint8_t *)((0x1D) + 0x20)) 
# 306 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
           &= ~(1 << 
# 306 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
                     1
# 306 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
    ...
    case 2:
# 326 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
      break;
...
# 372 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"

# 372 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
void __vector_1 (void) __attribute__ ((signal,used, externally_visible)) ; void __vector_1 (void) 
# 372 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
{ intFunc[0](); }

# 373 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
void __vector_2 (void) __attribute__ ((signal,used, externally_visible)) ; void __vector_2 (void) 
# 373 "C:\\PROGRA~2\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
{ intFunc[1](); }
